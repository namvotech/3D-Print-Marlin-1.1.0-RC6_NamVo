...
typedef struct {
  ...
  unsigned long acceleration_st;                     // acceleration steps/sec^2
	...
	unsigned long laser_power;  //NAMADD
  #endif
...
extern bool complete_state;
extern float complete_value;

extern bool life_time_state;

//NAMADD LED_RING
#if ENABLED(LED_RING)
	extern bool led_ring_blink_en;
	extern bool led_ring_heated_en;
	extern unsigned int led_ring_color;
	extern unsigned int led_ring_heated_color;
	extern unsigned int led_ring_time;
	extern int led_ring_number;
	extern bool led_ring_state;
	extern unsigned long led_ring_millis_number;
	extern unsigned int led_ring_counter_2;
#endif

//NAMADD Filament check
extern bool filament_check_enabled_a;
extern bool filament_check_enabled_b;
extern bool filament_check_enabled_c;
