 ...
 */
 ...
 #define EXTRUDE_MINTEMP 170
  ...
  #if (ENABLED(U8GLIB_SSD1306_I2C)|| ENABLED(U8GLIB_SSD1306_SPI))
    #define ULTRA_LCD  //general LCD support, also 16x2
   ...
   */
	...
	//NAMADD	
    const bool Z2_MIN_ENDSTOP_INVERTING =
...
//NAMADD Z TRIAD
 /**
   * Z_TRIAD_ENDSTOPS endstop reassignment
   */
	...
	//NAMADD	
    const bool Z3_MIN_ENDSTOP_INVERTING =
      #if Z3_USE_ENDSTOP == _XMAX_
        X_MAX_ENDSTOP_INVERTING
    ...
    const bool Z3_MAX_ENDSTOP_INVERTING =
      #if Z3_USE_ENDSTOP == _XMAX_
        X_MAX_ENDSTOP_INVERTING
    ...
    const bool Z4_MIN_ENDSTOP_INVERTING =
      #if Z4_USE_ENDSTOP == _XMAX_
        X_MAX_ENDSTOP_INVERTING
  ...
  #define HAS_Z2_MAX (PIN_EXISTS(Z2_MAX))
	#define HAS_Z3_MIN (PIN_EXISTS(Z3_MIN)) //NAMADD Z TRIAD
	#define HAS_Z3_MAX (PIN_EXISTS(Z3_MAX)) //NAMADD Z TRIAD  
	#define HAS_Z4_MIN (PIN_EXISTS(Z4_MIN)) //NAMADD Z TRIAD
  ...
  #define HAS_Z3_ENABLE (PIN_EXISTS(Z3_ENABLE))   //NAMADD Z TRIAD
  ...
  #define HAS_Z2_DIR (PIN_EXISTS(Z2_DIR))
    #define HAS_Z3_DIR (PIN_EXISTS(Z3_DIR)) //NAMADD Z TRIAD
  ...
  #define HAS_Z2_STEP (PIN_EXISTS(Z2_STEP))
	#define HAS_Z3_STEP (PIN_EXISTS(Z3_STEP))  //NAMADD Z TRIAD
