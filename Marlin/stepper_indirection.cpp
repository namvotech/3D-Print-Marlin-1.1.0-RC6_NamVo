...
//NAMADD Z TRIAD
  ...
  TMC26XStepper stepperZ3(200, Z3_ENABLE_PIN, Z3_STEP_PIN, Z3_DIR_PIN, Z3_MAX_CURRENT, Z3_SENSE_RESISTOR);
#endif
...
void L6470_init() {
  ...
  //NAMADD Z TRIAD
  #if ENABLED(Z3_IS_L6470)
    stepperZ3.init(Z3_K_VAL);
    stepperZ3.softFree();
    stepperZ3.setMicroSteps(Z3_MICROSTEPS);
    stepperZ3.setOverCurrent(Z3_OVERCURRENT); //set overcurrent protection
    stepperZ3.setStallCurrent(Z3_STALLCURRENT);
  #endif
