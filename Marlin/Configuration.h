...
//#define SCARA 
	...
	#define Linkage_1 160 // mm - Preprocessor cannot handle decimal points...
	// Length of outer support arm
	#define Linkage_2 140 // mm - Preprocessor cannot handle decimal points...

	// SCARA tower offset (position of Tower relative to bed zero position) 
	// This needs to be reasonably accurate as it defines the printbed position in the SCARA space.
	#define SCARA_offset_x  50 // mm
	#define SCARA_offset_y -50 // mm
	#define SCARA_RAD2DEG 57.2957795  // to convert RAD to degrees (Multiply by 180/Pi  -  theta is support arm angle)
...
*/
#define FDM_COREXY 
//#define FDM2001_DIAMOND_VITME 
//#define FDM500_DIAMOND
//#define SLA_PRINTER
//#define GALVO_LASER
...
//Function support
*/
//#define LASER_ENGRAVING_MODULE
//NAMADD MAX TEMP PROTECT
//#define MAXTEMP_PROTECT
#define HOME_TO_CENTER


#if ENABLED(FDM_COREXY)
	#define FDM_Z_SINGLE_COREXY
	//#define FDM_Z_DUAL_COREXY
	//#define FDM200_DIAMOND_COREXY
...
//	#define FDM_Z_TRIAD
	...
	#define GALVO_LASER_SPI
	//#define GALVO_LASER_I2C
...
/*
LED_RING ONLY ONE V1 OR V2 
*/
//#define LED_RING

#if ENABLED(LED_RING)		
	/*
	*led ring v1, on=0, off=1. led direction = counter-clockwise
	*/
	//#define LED_RING_LOW_V1

	/*
	*led ring v2, on=1, off=0. led direction = clockwise
	*/
	#define LED_RING_HIGH_V2
#endif
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD /*BOARD_3DFACTORY*//*BOARD_3DE_RAMPS_14*/BOARD_3DE_MAIN
#endif

// Optional custom name for your RepStrap or other custom machine
// Displayed in the LCD "Ready" message
#define CUSTOM_MACHINE_NAME "SCARA ROBOT"
...
// :[1,2,3,4]
#if ENABLED(FDM_COREXY)
	#if ENABLED(FDM_Z_DUAL_COREXY)||ENABLED(FDM_Z_SINGLE_COREXY)
		#define EXTRUDERS 1
	#else
		#define EXTRUDERS 1	
	#endif
#elif ENABLED(SLA_PRINTER)
	#define EXTRUDERS 1
#else
	#define EXTRUDERS 1
#endif
...
#define TEMP_BED_RESIDENCY_TIME 2  // (seconds) 10
 ...
 */
//NAMFIX THERMAL_PROTECTION_HOTENDS
...
#if ENABLED(FDM_COREXY)||ENABLED(FDM500_DIAMOND)
...
#define INVERT_Y_DIR false
	...
	#endif
#elif ENABLED(SLA_PRINTER)  //SLA_PRINTER
	#define INVERT_Z_DIR false
#elif ENABLED(FDM_COREXY)
	#if ENABLED(FDM_Z_SINGLE_COREXY)
		#define INVERT_Z_DIR true
	#elif ENABLED(FDM_Z_DUAL_COREXY)
		#define INVERT_Z_DIR false
	#else
		#define INVERT_Z_DIR false
	#endif
...
#if ENABLED(FDM500_DIAMOND)
	#define INVERT_E0_DIR false
	#define INVERT_E1_DIR false
	#define INVERT_E2_DIR false
	#define INVERT_E3_DIR false
#else
	//FDM_COREXY NEW vong lan ben trai
...
// #if ENABLED(GALVO_LASER) //SLS 
	// #define X_MAX_POS 118 
	// #define Y_MAX_POS 118
...
// #elif ENABLED(SLA_PRINTER) //SLA_PRINTER
	...
	// #define Z_MAX_POS 200	
// #else  //FDM
    // #if ENABLED(FDM500_DIAMOND)     //FDM500_DIAMOND
	...
	// #elif ENABLED(FDM_COREXY)
		...
		// #elif ENABLED(FDM_Z_SINGLE_COREXY)			
			// /*FDM200B1*/						
...
#if ENABLED(HOME_TO_CENTER)
	#define X_MIN_POS (-X_SIZE/2)
	#define Y_MIN_POS (-Y_SIZE/2)

	#define X_MAX_POS (X_SIZE/2)
	#define Y_MAX_POS (Y_SIZE/2)
#else
	#define X_MIN_POS 0
	#define Y_MIN_POS 0

	#define X_MAX_POS X_SIZE
	#define Y_MAX_POS Y_SIZE	
#endif
	#define Z_MIN_POS 0
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define XY_TRAVEL_SPEED 5000       //NAMFIX  // X and Y axis travel speed between probes, in mm/min.
...
// For deltabots this means top and center of the Cartesian print volume.
  ...
  #if ENABLED(SCARA)
	  #define MANUAL_X_HOME_POS SCARA_offset_x 
...
#else
	#if ENABLED (FDM500_DIAMOND)//FDM500_DIAMOND
		#define HOMING_FEEDRATE {50*60, 50*60, 1.67*60, 0}  // set the homing speeds (mm/min)	
	#elif ENABLED(FDM2001_DIAMOND_VITME)
		#define HOMING_FEEDRATE {1500, 1500, 1000, 0}  // set the homing speeds (mm/min) 
	#else	//FDM_COREXY
		#define HOMING_FEEDRATE {2000, 2000, 1000, 0}  // set the homing speeds (mm/min) 		
	#endif
...
// default settings
	 // default settings
	//#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,400,500}  // default steps per unit for Ultimaker
	//#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,1280,500}	
	//NAMADD
	/* Cong thuc de tinh toc do
	#define STEPS_PER_REVOLUTION_X 200*16  
	#define STEPS_PER_REVOLUTION_Y 200*16
	#if ENABLED(FDM500_DIAMOND)//FDM500_DIAMOND
		#define STEPS_PER_REVOLUTION_Z 200*32 //DRV8825,
	#else //FDM_COREXY 
		#define STEPS_PER_REVOLUTION_Z 200*4 //A4988,
	#endif
	#define STEPS_PER_REVOLUTION_E 200*16

	#define IDLER_TEETH_X 20  //Số Răng
	#define IDLER_TEETH_Y 20

	#define BELT_PITCH_X 2    //Khoảng cách giữa 2 răng
	#define BELT_PITCH_Y 2
	#if ENABLED(FDM500_DIAMOND)	//FDM500_DIAMOND
		#define PITCH_OF_Z_ROD 4  //Khoảng cách giữa 2 răng
	#elif ENABLED(FDM_COREXY)//FDM_COREXY
		#define PITCH_OF_Z_ROD 2  //Khoảng cách giữa 2 răng
	#endif
	...
	*/
#if ENABLED(GALVO_LASER)
	#define DEFAULT_AXIS_STEPS_PER_UNIT   {4095/X_MAX_POS,4095/Y_MAX_POS,4000,500}  //NAMFIX default steps per unit for Ultimaker
	#define DEFAULT_MAX_FEEDRATE          {10000, 10000, 5, 10000}    // (mm/sec)
	#define DEFAULT_MAX_ACCELERATION      {50000,50000,100,10000}     // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.

	#define DEFAULT_ACCELERATION          50000    // X, Y, Z and E acceleration in mm/s^2 for printing moves
	#define DEFAULT_RETRACT_ACCELERATION  3000    // E acceleration in mm/s^2 for retracts
	#define DEFAULT_TRAVEL_ACCELERATION   50000    // X, Y, Z acceleration in mm/s^2 for travel (non printing) moves
	...
	#define DEFAULT_MAX_FEEDRATE          {180, 180, 5, 25}    // (mm/sec)
	#define DEFAULT_MAX_ACCELERATION      {3000,3000,100,10000}    // X, Y, Z, E maximum start speed foraccelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
	#define DEFAULT_ACCELERATION          3000    // X, Y, Z and E acceleration in mm/s^2 for printing moves	
	#define DEFAULT_TRAVEL_ACCELERATION   3000    // X, Y, Z acceleration in mm/s^2 for travel (non printing) moves			
	#define DEFAULT_RETRACT_ACCELERATION  3000    // E acceleration in mm/s^2 for retracts
	// The speed change that does not require acceleration (i.e. the software might assume it can be done instantaneously)
	...
	#define DEFAULT_EJERK                 5     // (mm/sec)	
	...
	#elif ENABLED (FDM2001_DIAMOND_VITME)	
		#define AXIS_STEPS_PER_UNIT_X	200*16/8 //Vitme buoc 8 (8mm/1vong)
		#define AXIS_STEPS_PER_UNIT_Y   200*16/8
		#define AXIS_STEPS_PER_UNIT_Z	200*16/8	
		#define DEFAULT_AXIS_STEPS_PER_UNIT {AXIS_STEPS_PER_UNIT_X,AXIS_STEPS_PER_UNIT_Y, AXIS_STEPS_PER_UNIT_Z, 100}
		...
		//#define DEFAULT_AXIS_STEPS_PER_UNIT {80, 80, 400, 85}
//		#define DEFAULT_AXIS_STEPS_PER_UNIT {17.78, 17.78, 400, 85}
		//#define DEFAULT_MAX_FEEDRATE          {180, 180, 1000, 25}    // (mm/sec)
		#define DEFAULT_MAX_FEEDRATE          {300, 300, 100, 25}    // (mm/sec) //test truot dai
		
		#define DEFAULT_MAX_ACCELERATION      {2000,2000,1000,10000}    // X, Y, Z, E maximum start speed foraccelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
