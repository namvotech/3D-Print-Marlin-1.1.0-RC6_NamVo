...
#define E3_ENABLE_READ READ(E3_ENABLE_PIN)
  ...
  #define _REV_E_DIR() {if(current_block->active_extruder==1){E1_DIR_WRITE(INVERT_E1_DIR);}else{E0_DIR_WRITE(INVERT_E0_DIR);}}
    ...
    #define E_STEP_WRITE(v) _E_STEP_WRITE(v)01
...
//NAMADD Z TRIAD
  #if ENABLED(Z3_IS_TMC)
    extern TMC26XStepper stepperZ3;
    #undef Z3_ENABLE_INIT
    #define Z3_ENABLE_INIT ((void)0)

    #undef Z3_ENABLE_WRITE
    #define Z3_ENABLE_WRITE(STATE) stepperZ3.setEnabled(STATE)

    #undef Z3_ENABLE_READ
...
//////////////////////////////////
  ...
  //NAMADD Z TRIAD
    ...
    #undef Z3_ENABLE_WRITE
    #define Z3_ENABLE_WRITE(STATE) (if(STATE) stepperZ3.Step_Clock(stepperZ3.getStatus() & STATUS_HIZ); else stepperZ3.softFree();)

    #undef Z3_ENABLE_READ
    #define Z3_ENABLE_READ (stepperZ3.getStatus() & STATUS_HIZ)

    #undef Z3_DIR_INIT
    #define Z3_DIR_INIT ((void)0)

    #undef Z3_DIR_WRITE
    #define Z3_DIR_WRITE(STATE) stepperZ3.Step_Clock(STATE)

    #undef Y3_DIR_READ
    #define Y3_DIR_READ (stepperZ3.getStatus() & STATUS_DIR)
  #endif 
