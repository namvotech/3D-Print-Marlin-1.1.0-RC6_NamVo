...
#elif MB(3DE_MAIN)  
  #include "pins_3DE_MAIN.h"
#elif MB(3DMIRACLES)
  #include "pins_3DMIRACLES.h"
#elif MB(3DFACTORY)
  #include "pins_3DFACTORY.h"  
...
#elif MB(3DE_RAMPS_14)
  #include "pins_3DE_RAMPS_14.h"
#elif MB(GEN6)
  #include "pins_GEN6.h"
#elif MB(GEN6_DELUXE)
...
#elif ENABLED(Z_TRIAD_STEPPER_DRIVERS) //NAM ADD Z TRIAD
  #undef _E1_PINS
  #undef _E2_PINS
  #define _E1_PINS E1_STEP_PIN, E1_DIR_PIN, E1_ENABLE_PIN,
...
#ifndef Z3_STEP_PIN
  #define Z3_STEP_PIN   _EPIN(2, STEP)
  #define Z3_DIR_PIN    _EPIN(2, DIR)
  #define Z3_ENABLE_PIN _EPIN(2, ENABLE)
#endif
