 ...
 */
#if ENABLED(Z_TRIAD_STEPPER_DRIVERS) && ENABLED(Z_DUAL_STEPPER_DRIVERS) && ENABLED(Y_DUAL_STEPPER_DRIVERS)
...
#elif ENABLED(Z_TRIAD_ENDSTOPS) && (!defined(Z2_USE_ENDSTOP)||!defined(Z3_USE_ENDSTOP)) //NAMADD Z TRIAD
  #error Z_TRIAD_ENDSTOPS settings are simplified. Just set Z2_USE_ENDSTOP to the endstop you want to repurpose for Z2 and set Z3_USE_ENDSTOP to the endstop you want to repurpose for Z3 
#endif
